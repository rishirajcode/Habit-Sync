...
export default function Report() {
    ...
    if (loading) return <div className="glass-panel" style={{ padding: '24px' }}>Generating your weekly report...</div>;

    return (
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <header style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    <h1 style={{ color: 'var(--primary-color)' }}>Weekly Report</h1>
                    <p style={{ color: 'var(--text-secondary)' }}>A summary of your journey over the last 7 days.</p>
                </div>
            ...
            <div ref={reportRef} style={{ padding: '20px', borderRadius: '12px', background: 'var(--bg-primary)' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px', marginBottom: '32px' }}>
                    ...
                    <div className="glass-panel" style={{ padding: '24px', textAlign: 'center' }}>
                        ...
                        <p style={{ fontSize: '12px', color: 'var(--text-secondary)', margin: 0 }}>Over 7 days</p>
                    </div>
                ...
                <section className="glass-panel" style={{ padding: '32px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px', padding: '16px', background: 'var(--bg-secondary)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)' }}>
                        ...
                        <div>
                            ...
                            <p style={{ margin: 0, color: 'var(--text-secondary)', marginTop: '4px' }}>Total water tracking sessions in 7 days: {reportData.totalLogs}</p>
                        </div>
                    </div>
                </section>
            </div>
